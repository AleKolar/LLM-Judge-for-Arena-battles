...
## 🧠 Текущий промпт Судьи (свободный анализ)

Промпт Судьи сознательно исполнен в такой формулировке, чтобы дать модели свободу экспертного анализа и оценить её способность самостоятельно применять знания без жёстких инструкций.  
Модель сама выбирает критерии, находит доказательства и строит аргументацию, демонстрируя глубину инженерного мышления.

Файл `src/prompts/judge_prompt.md`:
